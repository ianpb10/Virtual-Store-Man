...
{
    public partial class calca : Form
    {
        public calca()
        {
            InitializeComponent();
        ...
        private void vestido_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Agradecemos pela sua preferência. Você será redirecionado ao seu carrinhol");
            }
